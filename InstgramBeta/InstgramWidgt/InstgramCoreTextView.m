...
//    CGSize size = [_text sizeWithFont:_textFont constrainedToSize:CGSizeMake(self.bounds.size.width, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
//    [self setFrame:CGRectMake(20, 20, self.bounds.size.width, size.height)];
    
    //表情符用@" "代替 其他不变
//    NSString* analyzedText = [self analyseText:_text];
//    
//    NSMutableAttributedString* attString = [[NSMutableAttributedString alloc] initWithString:analyzedText];
// 
//    //设置字体
